...
## Loading data sets
#se cargan los csv con la informacion de la segmentacion de imagenes de melanomas 

# se une la informacion y se le pone sus labels correspondientes

```{r FRESA Map, results = "hide", dpi=300, fig.height= 6.0, fig.width= 8.0}
op <- par(no.readonly = TRUE)

MelanomaFeatures <- read.csv("C:/Users/meili/OneDrive/Desktop/SKINCANCER/MatlabScripts/MelanomaLesionFeatures.csv", header=FALSE)
SeborrheicFeatures <- read.csv("C:/Users/meili/OneDrive/Desktop/SKINCANCER/MatlabScripts/SeborrheicLesionFeatures.csv", header=FALSE)
NevusFeatures <- read.csv("C:/Users/meili/OneDrive/Desktop/SKINCANCER/MatlabScripts/NevusLesionFeatures.csv", header=FALSE)
MelanomaControlFeatures <- read.csv("C:/Users/meili/OneDrive/Desktop/SKINCANCER/MatlabScripts/MelanomaControlFeatures.csv", header=FALSE)
SeborrheicControlFeatures <- read.csv("C:/Users/meili/OneDrive/Desktop/SKINCANCER/MatlabScripts/SeborrheicControlFeatures.csv", header=FALSE)
NevusControlFeatures <- read.csv("C:/Users/meili/OneDrive/Desktop/SKINCANCER/MatlabScripts/NevusControlFeatures.csv", header=FALSE)
...
## The Heatmap
#este heatmap exhibe la informacion de las caracteristicas de las imagenes, al igual que la clase a la que pertenece cada imagen
...
# modelo entrenado por el metodo de KNN, el 70% de la informacion es utilizada para el entrenamiento
...
# SVM con diferente tipo de Class Sampling
...
# modelo de Naive Bayes con diferente funcion de feature selection
```{r}
